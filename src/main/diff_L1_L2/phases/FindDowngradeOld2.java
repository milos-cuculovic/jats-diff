 ...
 * documenti
 */
public class FindDowngradeOld2 extends Phase {
     ...
     */
    public FindDowngradeOld2(NxN SearchField, Relation Rel, Dtree Ta, Dtree Tb,
                             Nconfig cfg) {
...
//                    for (Dnode fromNode : A.nodeList) {
                    for (int j = processField.xRef.inf; j <= processField.xRef.sup; j++) {
                        ...
                        if (
                                //ArrayUtils.indexOf(TAGS, toNode.getRefDomNode().getNodeName()) > -1
                            ...
                            if (titleSub && toNode.getRefDomNode().getNodeName().equals(fromNode.getRefDomNode().getNodeName())
                                    && toNode.posLikeChild.intValue() > fromNode.posLikeChild.intValue()) {
